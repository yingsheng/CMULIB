...
public class DataFileProcesser {
	 ...
	 *             when it happens
	 */
	public String[][] processingData(String srcDataFile, String delimiter,
			String dataType, double samplingRate, String sampleFileName)
			throws Exception {
		...
		for (int i = 0; i < matrix[0].length; i++) {
			...
			if (!this.chcekSuccessful(flags) && wrongDataTypeStrategy != null) {
				this.wrongDataTypeStrategy.handleWrongDataTypeInaColumn(matrix,
						i, flags);
			}
		}
		br.close();
